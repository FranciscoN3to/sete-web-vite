...
const texts = { selected: { title: "Lista de Escolas" }, notSelected: { title: "Escolas atendidos pela rota" } };
...
const EscolasAtendidas: React.FC = () => {
    ...
    return (
        <Container>
            ...
            <ReactHookDualMultiSelect texts={texts} name="escolas" options={escolasList} />
            <ButtonsContainer>
